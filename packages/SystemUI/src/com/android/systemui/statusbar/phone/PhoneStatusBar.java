...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    private ContentObserver mUserSetupObserver = new ContentObserver(new Handler()) {
        ...
        public void onChange(boolean selfChange) {
            ...
            if ((mHaloButton != null || mHoverButton != null) && mHasFlipSettings) {
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        mLeftClock = (Clock)mStatusBarView.findViewById(R.id.left_clock);
    ...
    protected void refreshLayout(int layoutDirection) {
        ...
        if (mHaloButton != null && mHaloButton instanceof ImageView) {
            // Force asset reloading
            ((ImageView)mHaloButton).setImageDrawable(null);
            ((ImageView)mHaloButton).setImageResource(R.drawable.ic_notify_halo_normal);
        }
    ...
    protected void setAreThereNotifications() {
        ...
        clearable = any && mNotificationData.hasClearableItems();
    ...
    public void showClock() {
        ...
        mLeftClock.updateClockVisibility(mShowClock);
    }
    ...
    Animator mScrollViewAnim, mFlipSettingsViewAnim, mNotificationButtonAnim,
        mSettingsButtonAnim, mHaloButtonAnim, mClearButtonAnim, mEditModeButtonAnim, mRibbonViewAnim, mAddTileButtonAnim, mHoverButtonAnim;
    ...
    public void partialFlip(float progress) {
        ...
        if (progress < 0f) { // notifications side
            ...
            if (clearable) {
                mClearButton.setVisibility(View.VISIBLE);
                mClearButton.setAlpha(-progress);
            }
            if (mHaloEnabled) {
                mHaloButton.setVisibility(View.VISIBLE);
    ...
    private class MyTicker extends Ticker {
        ...
        public void tickerStarting() {
            ...
            if (!mHaloActive) {
                ...
                mLeftClockLayout.startAnimation(loadAnim(com.android.internal.R.anim.push_up_out, null));
        ...
        public void tickerDone() {
            if (!mHaloActive) {
                ...
                mLeftClockLayout.startAnimation(loadAnim(com.android.internal.R.anim.push_down_in, null));
        ...
        public void tickerHalting() {
            if (!mHaloActive) {
                ...
                mLeftClockLayout.setVisibility(View.VISIBLE);
                mLeftClockLayout.startAnimation(loadAnim(com.android.internal.R.anim.fade_in, null));
